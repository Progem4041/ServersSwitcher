...
public final class ServerConnectionHelper {
    ...
    /**
     * После {@code world.disconnect()} клиент уже не в мире — {@link GameMenuScreen} нельзя открывать как экран
     * возврата из {@link ConnectScreen} (отмена / ошибка подключения), иначе ваниль падает или ведёт себя некорректно.
     */
